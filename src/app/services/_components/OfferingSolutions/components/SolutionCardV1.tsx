...
export function SolutionCardV1({ src, name, slogan, points, price }: Props) {
  return (
    <AppearInSight>
      <div className="bg-zinc-900 text-white w-full p-5 border border-gray-800 rounded-3xl flex flex-col lg:flex-row gap-10 hover:-translate-y-1 transition-transform duration-200">
        <Image
          className="rounded-xl lg:w-6/12 aspect-square object-cover"
          src={src}
          alt={name}
          width={1024}
          height={1024}
